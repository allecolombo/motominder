# 🏍️ MotoMinder V2 - Landing Page Premium

Landing page di validazione per MotoMinder - l'app definitiva per ogni motociclista.

## ✨ Cosa offre MotoMinder

1. **Scadenze & Promemoria** - Bollo, revisione, assicurazione, tagliandi via WhatsApp
2. **Scheda Tecnica Completa** - Tutti i dati della moto dalla targa
3. **Diario Manutenzioni** - Storico interventi con costi e ricevute
4. **Tracker Costi** - Quanto costa davvero la tua moto
5. **MotoGP & News** - Calendario gare, classifiche, notifiche

## 📁 Struttura File

```
motominder/
├── index.html      # Pagina HTML principale (premium design)
├── styles.css      # Stili CSS (racing theme, dark mode)
├── script.js       # JavaScript (traduzioni IT/EN, form, animazioni)
...
- 🎨 **Design Racing Premium** - Tema scuro, accenti fuoco, animazioni
- 📧 **Formspree Ready** - Raccolta email integrata
- ⚡ **Animazioni Scroll** - Feature cards, stats, steps
- 🔍 **SEO Ready** - Meta tags, Open Graph
- 📊 **Counter Social Proof** - Mostra iscritti in tempo reale
- 🏁 **Preview MotoGP** - Mockup sezione classifiche
